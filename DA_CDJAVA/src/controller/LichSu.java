...
public class LichSu extends javax.swing.JFrame {
    ...
    public void DocFile() throws IOException {
        String data = "Điểm\tThời gian\tKết quả\n";
        BufferedReader br = new BufferedReader(new FileReader("LichSuGame.txt"));
        String s;
        while((s = br.readLine()) != null){
            data += new String(s.getBytes(),"UTF-8");
            data +="\n";
        }
        TaLichSu.setText(data);
    }
    
    public LichSu() {
        initComponents();
        TaLichSu.setEditable(false);
        try{
            DocFile();
    ...
    private void initComponents() {
        ...
        TaLichSu = new javax.swing.JTextArea();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        TaLichSu.setColumns(20);
        TaLichSu.setRows(5);
        jScrollPane1.setViewportView(TaLichSu);
    ...
    private javax.swing.JTextArea TaLichSu;
